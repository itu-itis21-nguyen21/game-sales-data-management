...
int main(int argc, char* argv[]) {
    ...
    cout << "Time taken to insert all data into RBT: " << insertion_duration.count() << " microseconds" << endl;
    ...
    cout << "Average time for " <<  times << " random searches RBT: " << search_duration.count() / times << " nanoseconds" << endl;
    
    int RBTree_depth = RBTree.in_order_traversal(RBTree.get_root(), 0);
    cout << "RBTree_depth: " << RBTree_depth << endl;
    /////////////////////////////////////////////////////////////////////////////////////////////
    ...
    cout << "RBTree_sorted_depth: " << RBTree_sorted_depth << endl;
    ...
    cout << "Average time for " << times << " random searches RBT SORTED: " << search_duration_sorted.count() / times << " nanoseconds" << endl;
    /////////////////////////////////////////////////////////////////////////////////////////////
...
void RB_tree::preorder() {
    ...
    if (this->root != NULL) {
        ...
        while (!s.empty()) {
            ...
            cout << "(" << (node->get_color() == 1 ? "RED" : "BLACK") << ") " << node->key.name << endl;
...
void RB_tree::find_best_seller() {
    ...
    // cout << "Maximum depth of the RBT: " << max_depth << endl;
}
