...
public:    
    ...
    stack<string> tree_deep_stack; // a stack to track traversal depth
...
void publishers_random_search(const vector<string>& publisher_names, BST_tree& BSTree, int times) {
    for (int i = 0; i < times; i++) {
        ...
        if (found_publisher != nullptr) {
            //cout << "Publisher found: " << publisher_to_search << " EU Sales: " << found_publisher->key.eu_sales << endl;
        } else {
            //cout << "Publisher not found: " << publisher_to_search << endl;
        }
    }
}
...
int main(int argc, char* argv[]) {
    ...
    cout << "Time taken to insert all data into BST: " << insertion_duration.count() << " microseconds" << endl;
    ...
    cout << "Average time for " << times << " random searches BST: " << search_duration.count() / times << " nanoseconds" << endl;
    
    int BSTree_depth = BSTree.in_order_traversal(BSTree.get_root(), 0);
    cout << "BSTree_depth: " << BSTree_depth << endl;
    /////////////////////////////////////////////////////////////////////////////////////////////
    ...
    cout << "BSTree_sorted_depth: " << BSTree_sorted_depth << endl;
    ...
    cout << "Average time for " << times << " random searches BST SORTED: " << search_duration_sorted.count() / times << " nanoseconds" << endl;
    /////////////////////////////////////////////////////////////////////////////////////////////
...
Node* BST_tree::BST_insert(Node* root, Node* ptr) {
    ...
    if (ptr->key.name < root->key.name) {
        ...
        //cout << "new values for the key: " << ptr->key.name << " = " << root->key.na_sales << "," << root->key.eu_sales << "," << root->key.others_sales << endl; 
    }
...
void BST_tree::find_best_seller() {
    ...
    //cout << "Maximum depth of the BST: " << max_depth << endl;
}
